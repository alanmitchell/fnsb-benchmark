...
def building_type_comparison_graph(df, graph_column, site, filename):
    ...
    site_df = alan_df.query("site_id == @site")
    ...
    usage_type_df = alan_df.query("primary_func == @usage_type")
    ...
    plot_title = graph_column.upper() + " Comparison for " + usage_type + " Buildings"
