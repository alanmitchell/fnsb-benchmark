...
def utility_cost_report(site, df, ut):
    ...
    # Only include non-zero utilities in list pased to plot legend
    utility_list = dict(filter(lambda x: x[1], non_zero.items()))
...
def energy_use_cost_reports(site, df, ut, df_utility_cost):
    ...
    # test_cols = dict(filter(lambda x: x[1], non_zero.items()))
    # print(test_cols)
    # print(usage_cols)
